      ...
      <DialogContent className="bg-light text-dark overflow-hidden fixed top-1/2 left-1/2 transform translate-x-[-50%]! translate-y-[-50%]!">
        ...
        <ScrollArea className="mt-8 max-h-[420px] pr-6">
          {server?.members?.map((member) => (
            <div key={member.id} className="flex items-center gap-x-2 mb-7">
                  ...
                  <div className="ml-auto">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent side="right">
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuItem
                          className="text-rose-400 *:text-rose-400! hover:text-rose-300! hover:*:text-rose-300!"
              ...
              {loadingId === member.id && (
                <Loader2 className="animate-spin text-orange ml-auto w-4 h-4" />
              )}
            </div>
          ))}
        </ScrollArea>
