...
export const ServerHeader = ({
  ...
  return (
    <DropdownMenu>
      ...
      >
        <button
          className="w-full text-md font-montserrat font-semibold px-3 flex items-center h-12 border-orange/20 dark:border-neutral-900/90 border-b-2 hover:bg-beige/80 dark:hover:bg-zinc-700/30 transition"
        >
          {server.name}
